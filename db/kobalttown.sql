...
BEGIN
    INSERT INTO `kobalttown`.`log_validation_code` (`crud`, `id`, `account`, `email`, `token`, `expire_at`, `status`, `status_at`, `created_at`, `updated_at`, `modify_ts`)
