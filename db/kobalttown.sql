...
BEGIN
    INSERT INTO `kobalttown`.`log_validation_code` (`crud`, `id`, `account`, `code`, `expire_at`, `used_at`, `expired_at`, `created_at`, `updated_at`, `modify_ts`)
    VALUES ('U', OLD.`id`, OLD.`account`, OLD.`code`, OLD.`expire_at`, OLD.`used_at`, OLD.`expired_at`, OLD.`created_at`, OLD.`updated_at`, OLD.`modify_ts`);
END$$
...
BEGIN
    INSERT INTO `kobalttown`.`log_validation_code` (`crud`, `id`, `account`, `code`, `expire_at`, `used_at`, `expired_at`, `created_at`, `updated_at`, `modify_ts`)
    VALUES ('D', OLD.`id`, OLD.`account`, OLD.`code`, OLD.`expire_at`, OLD.`used_at`, OLD.`expired_at`, OLD.`created_at`, OLD.`updated_at`, OLD.`modify_ts`);
END$$
