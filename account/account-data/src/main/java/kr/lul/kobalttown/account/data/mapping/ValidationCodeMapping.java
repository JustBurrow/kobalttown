...
public abstract class ValidationCodeMapping {
  ...
  public static final String TABLE = "validation_code";
  ...
  public static final String IDX_VALIDATION_CODE_VALID_COLUMNS = COL_EXPIRE_AT + " DESC, " + COL_EXPIRED_AT + " DESC, " + COL_USED_AT + " DESC";
